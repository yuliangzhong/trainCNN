...
parser.add_argument('--n', type=str, default='2', help='model number')
args = parser.parse_args()
modelNo = args.n

time.sleep(int(modelNo))
...
angLayer = Dense(256, activation='relu')(Ang_input)
...
# fit and predict
model.fit([xAngtrain, xMaptrain], ytrain, batch_size=16,epochs=400)
